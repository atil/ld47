...
{
    public const float FireFovKickDuration = 0.4f;
    public const float FireFovKickCoeff = 1.05f;

    public const float TeleportFovKickDuration = 0.75f;
    public const float TeleportFovKickCoeff = 1.45f;
